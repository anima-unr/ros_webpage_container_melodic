...
//         ros::init(argc,argv,"roslaunch_launcher_4");
//         ros::NodeHandle n;
       
// 	ros::Subscriber sub_2 = n.subscribe("/launch_4", 1, callback_4);
...
int main(int argc, char** argv){
    ros::init(argc, argv, "roslaunch_launcher_4");
    ros::NodeHandle n;
    ros::Subscriber sub_run = n.subscribe("/launch_4",100,callback_run);
    ros::Subscriber sub_kill = n.subscribe("/kill_4",100,callback_kill);
    ros::spin();
    return 0;
}