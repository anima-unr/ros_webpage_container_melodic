...
//         ros::init(argc,argv,"roslaunch_launcher_int_marker");
//         ros::NodeHandle n;
       
// 	ros::Subscriber sub_2 = n.subscribe("/launch_int_marker", 1, callback_4);
...
int main(int argc, char** argv){
    ros::init(argc, argv, "roslaunch_launcher_int_marker");
    ros::NodeHandle n;
    ros::Subscriber sub_run = n.subscribe("/launch_int_marker",100,callback_run);
    ros::Subscriber sub_kill = n.subscribe("/kill_int_marker",100,callback_kill);
    ros::spin();
    return 0;
}