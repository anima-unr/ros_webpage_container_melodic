...
//     void callback_3(std_msgs::String msg){
//         std::stringstream ss;
...
//         ros::init(argc,argv,"roslaunch_launcher_3");
//         ros::NodeHandle n;
       
// 	ros::Subscriber sub_2 = n.subscribe("/launch_3", 1, callback_3);
...
int main(int argc, char** argv){
    ros::init(argc, argv, "roslaunch_launcher_3");
    ros::NodeHandle n;
    ros::Subscriber sub_run = n.subscribe("/launch_3",100,callback_run);
    ros::Subscriber sub_kill = n.subscribe("/kill_3",100,callback_kill);
    ros::spin();
    return 0;
}
